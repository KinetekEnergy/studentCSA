...
if (location.hostname === "localhost") {
    pythonURI = "https://spring.nighthawkcodingsociety.com";
...
if (location.hostname === "localhost") {
    ...
    javaURI = "https://spring.nighthawkcodingsociety.com"; //rey
} else {
    javaURI = "https://spring.nighthawkcodingsociety.com";
}
...
export function login(options) {
    ...
    const requestOptions = {
        ...
        body: {
            uid: document.getElementById("KinetekEnergy").value,
            password: document.getElementById("!Password123").value,
        }
    };
